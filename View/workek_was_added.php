...
<head>
    ...
    <title>Сотрудник добавлен</title>
    <meta name="description" content="Сообщение о добавлении сотрудника">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link href="https://unpkg.com/tailwindcss@^2/dist/tailwind.min.css" rel="stylesheet">
</head>
<body>
    <div class="mt-8 inline-flex flex-col space-y-2.5 items-center justify-center">
        <p class="text-4xl text-center">Сотрудник добавлен</p>
